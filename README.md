...
Relational databases are a type of database that allow us to access data in relation to another piece of data in the form of tables. These relational databases often use SQL (which is a query language) to access the database.

1. Why do tables need a `primary key`?

Because they allow us to uniquely identify all table records
